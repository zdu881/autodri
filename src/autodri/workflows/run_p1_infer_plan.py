...
def main() -> None:
    ...
    args.gaze_cls_model = str(
        resolve_existing_path(
            "" if args.gaze_cls_model == "models/gaze_cls_p1_200shot_driveonly_ft_v1.onnx" else args.gaze_cls_model,
    ...
    args.gaze_scrfd = str(
        resolve_existing_path(
            "" if args.gaze_scrfd == "models/scrfd_person_2.5g.onnx" else args.gaze_scrfd,
    ...
    if not wheel_weights:
        ...
        wheel_weights = str(resolve_existing_path(wheel_weights, description="wheel weights"))
    if args.run_wheel:
        if wheel_weights:
