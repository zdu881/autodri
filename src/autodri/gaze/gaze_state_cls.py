...
from autodri.gaze.ort_runtime import ensure_onnxruntime_cuda_runtime
...
def main() -> None:
    ...
    args.scrfd = str(
        resolve_existing_path(
            "" if args.scrfd == "models/scrfd_person_2.5g.onnx" else args.scrfd,
    ...
    args.cls_model = str(
        resolve_existing_path(
            "" if args.cls_model == "models/gaze_cls_yolov8n.onnx" else args.cls_model,
